...
type IconName = 'AiOutlineDashboard' | 'AiOutlineUser' | 'AiOutlineQuestionCircle' | 'AiOutlineAssignment' | 'LiaQuestionSolid' | 'FaComputer' | 'PiUsersThreeFill'; // Include all icons used in navOptions
            ...
            <aside className="w-[15vw] bg-gray-800 p-4 space-y-4">
                ...
                <nav className="space-y-2 flex flex-col gap-4 w-full">
                    {navOptions.map((option) => (
                        ...
                        >
                            <span className="flex items-center gap-4 rounded w-full py-2 px-4 text-white hover:bg-white hover:text-black font-semibold text-sm bg-[#6807e7]">
